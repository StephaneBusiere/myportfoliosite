...
export default class Skipatrol extends React.Component{
    render() {
        ...
        return(
            ...
            <ul >
            <li className={styles.skiMenuItem}>13 winter seasons<img className={styles.winterIcon} src={winter} ></img></li>  
            <li className={styles.skiMenuItem}>6 differents resorts<img className={styles.mountainIcon} src={mountain} ></img></li>
            <li className={styles.skiMenuItem}>Avalanche specialist<img className={styles.avalancheIcon} src={avalanche} ></img></li>
            <li className={styles.skiMenuItem}>weather specialist<img className={styles.weatherIcon} src={weather} ></img></li>
